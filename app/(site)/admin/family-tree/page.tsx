    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-8 sm:py-12">
      ...
      <header className="mt-4">
        ...
        <p className="mt-3 max-w-2xl text-pretty text-sm leading-relaxed text-[var(--color-ink-muted)] sm:text-base">
          Private genealogy canvas from your Quick Family Tree export. Use fullscreen for a larger
          view (Esc to exit). Right-click or press-and-hold a circle for the action list. Only admin
          sessions can open this page.
        </p>
      </header>
