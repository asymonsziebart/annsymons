...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    description:
      "Flaky buttery crust, stovetop-cooked apple filling, and a golden crisp crumb streusel topping.",
    prepTime: "45 min",
    cookTime: "1 hr 20 min",
    servings: "10",
    ingredients: [
      "1 homemade single pie crust",
      "Apple filling: ¼ tsp lemon zest",
      ...
      "1 tsp vanilla",
      "Sugar crumble: 1½ cups all-purpose flour",
      "⅓ cup granulated sugar",
      "¾ cup brown sugar, packed",
      "½ tsp kosher salt",
    ...
    steps: [
      "Peel and slice apples into ⅛-inch pieces. Zest lemon into a 12-inch high-sided skillet (heat off), add lemon juice, and toss apples in as you slice to prevent browning.",
      "Set skillet over medium heat. Add brown sugar, granulated sugar, flour, salt, cinnamon, nutmeg, and cardamom (optional). Stir gently. Cover and cook 20 minutes, stirring every 3 minutes, until apples are fork-tender but hold their shape. Add 1 tbsp water if sticking.",
      "Remove from heat; stir in vanilla. Spread filling on a half sheet pan and chill completely (freezer ~30 min or fridge).",
      "Roll pie dough into a 9-inch pie dish; crimp edges. Chill crust 30 minutes.",
      "Place a baking sheet or pizza stone on the center oven rack; preheat to 425°F for 20–30 minutes.",
      "Crumble: whisk flour, granulated sugar, brown sugar, and salt. Stir in melted butter until sandy with some clumps. Chill until assembly.",
      "Pour chilled filling into chilled crust. Top with about 1–2 cups crumble (reserve the rest). Bake on the hot baking sheet 15 minutes at 425°F.",
      "Reduce oven to 350°F without removing the pie; bake 10 more minutes.",
      "Remove pie, sprinkle remaining chilled crumble on top, and shield crust edges with a foil ring. Bake at 350°F 25–35 minutes until crumble is light golden and crust edges are brown.",
      "Cool on a wire rack at least 4 hours before slicing. Store covered at room temperature up to 2 days, then refrigerate.",
    ],
  },
];
